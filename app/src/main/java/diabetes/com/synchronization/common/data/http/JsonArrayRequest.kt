...
class JsonArrayRequest(method: Int, url: String, requestBody: String, responseHandler: HttpResponseHandler<*, *>, val context: Context) : JsonArrayRequest(method, url, JSONArray(requestBody), responseHandler as Response.Listener<JSONArray>, responseHandler as Response.ErrorListener), BaseRequestProperties {
