...
class JsonObjectRequest(method: Int, url: String, requestBody: String, responseHandler: HttpResponseHandler<*, *>, val context: Context) : JsonObjectRequest(method, url, JSONObject(requestBody), responseHandler as Response.Listener<JSONObject>, responseHandler as Response.ErrorListener), BaseRequestProperties {
